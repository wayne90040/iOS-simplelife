...
public protocol IPieChartDataSet: IChartDataSet
{
    ...
    /// custom:  the width used for drawing borders around the slices. If borderWidth == 0, no border will be drawn.
    var sliceBorderWidth: CGFloat { get set }
    
    /// custom: the color drawing borders around the slices.
